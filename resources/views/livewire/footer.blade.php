        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <p class="text-gray-400 mb-4">
                    Building the future of digital solutions with cutting-edge technology and exceptional service.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('customer.home') }}" class="hover:text-white transition-colors duration-200">
                            Home
                        </a>
                    </li>
                    <li>
            ...
            <div>
                ...
                <form wire:submit.prevent="subscribe" class="space-y-2">
                    <input 
                        ...
                        class="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    >
                    @error('email')
                    ...
                    <button 
                        type="submit"
                        class="w-full px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300"
                    >
                        Subscribe
                    </button>
                </form>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 text-sm">
                    © {{ date('Y') }} Logo. All rights reserved.
                </p>
